            ...
            <section className="iframeSec">
              <div className="playlist-buttons">
                <div className="pt">
                  ...
                  { playlistEntries.map((playlist) => <button 
                ...
                <div className="pr">
                  ...
                  <div className="playlist-random">
                    <button className="button is-primary"  onClick={ this.previousPlayList } ><i class="fas fa-arrow-alt-circle-left"></i></button>
                    <button className="button is-primary"  onClick={ this.randomPlaylist } > Aleatória </button>
                    <button className="button is-primary"  onClick={ this.nextPlayList } ><i class="fas fa-arrow-alt-circle-right"></i></button>
                  </div>
                </div>
              </div>
                <iframe
